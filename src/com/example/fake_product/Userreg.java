...
public class Userreg extends Activity {
    ...
    private class ActiveTask1 extends AsyncTask<String,Void,Void> {
		...
		protected void onPreExecute() {
			...
			Toast.makeText(getApplicationContext(), "Please wait......"+s1, Toast.LENGTH_LONG).show();
			
		}

		@Override
		protected Void doInBackground(String... params) {
			res=Callservice.uregisterService(s1,s2,s3,s4,"URegister");			
			return null;		
		}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.userreg, menu);
		return true;
	}
