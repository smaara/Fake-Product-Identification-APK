...
public class Retailor extends Activity {
	EditText e1,e2;
	Button b1,b2;
	ProgressBar pb1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_retailor);
		...
		b2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent in=new Intent(getApplicationContext(), Retailor_Reg.class);
				startActivity(in);
			}
		});
	...
	protected void onPostExecute(Void result) {
		...
		if(res.equals("success")) {
					...
					Intent intent=new Intent(getBaseContext(),RDhome.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.retailor, menu);
		return true;
	}
